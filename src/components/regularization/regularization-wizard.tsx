...
const STEP_TIPO: WizardQuestion = {
  ...
  helpText: null,
  options: [
    { key: "AMPLIACION", label: "Ampliación", description: null, imageUrl: null, numericValue: null },
    { key: "SEGUNDO_PISO", label: "Segundo piso", description: null, imageUrl: null, numericValue: null },
    { key: "TERRAZA_CERRADA", label: "Terraza cerrada", description: null, imageUrl: null, numericValue: null },
    { key: "QUINCHO", label: "Quincho", description: null, imageUrl: null, numericValue: null },
    { key: "BODEGA", label: "Bodega", description: null, imageUrl: null, numericValue: null },
    { key: "ESTACIONAMIENTO_TECHADO", label: "Estacionamiento techado", description: null, imageUrl: null, numericValue: null },
    { key: "VIVIENDA_COMPLETA", label: "Vivienda completa", description: null, imageUrl: null, numericValue: null },
    { key: "OTRO", label: "Otro", description: null, imageUrl: null, numericValue: null },
  ],
  stepGroup: null,
...
const STEP_RECEPCION: WizardQuestion = {
  ...
  helpText: null,
  options: [
    { key: "si", label: "Sí", description: null, imageUrl: null, numericValue: null },
    { key: "no", label: "No", description: null, imageUrl: null, numericValue: null },
    { key: "no_se", label: "No estoy seguro", description: null, imageUrl: null, numericValue: null },
  ],
  stepGroup: null,
  visibleIfQuestionKey: null,
  visibleIfValues: [],
...
const STEP_MATERIAL: WizardQuestion = {
  ...
  helpText: null,
  options: [
    { key: "MADERA", label: "Madera", description: null, imageUrl: null, numericValue: null },
    { key: "ALBANILERIA", label: "Albañilería", description: null, imageUrl: null, numericValue: null },
    { key: "METALCON", label: "Metalcón", description: null, imageUrl: null, numericValue: null },
    { key: "HORMIGON", label: "Hormigón", description: null, imageUrl: null, numericValue: null },
    { key: "MIXTA", label: "Mixta", description: null, imageUrl: null, numericValue: null },
    { key: "OTRO", label: "Otro", description: null, imageUrl: null, numericValue: null },
  ],
  stepGroup: null,
  visibleIfQuestionKey: null,
