...
export function ExplorationToggle({
  ...
  return (
    <section
      ...
      className="bg-concrete border-t border-[#E7EAF0] px-4 sm:px-10 py-4 sm:py-6 pb-6 sm:pb-9 flex flex-col gap-3 sm:gap-4 scroll-mt-16 md:scroll-mt-20"
    >
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="font-body text-[12px] font-bold uppercase mb-1 text-ds-text-tertiary" style={{ letterSpacing: "0.08em" }}>
            Explora
          </p>
          <h2
            className="font-display text-[16px] sm:text-[18px] font-extrabold text-ds-navy-900"
        ...
        <div className="inline-flex rounded-full border border-[#E4E8EF] bg-white p-1">
          <button
            ...
            className={`h-9 flex items-center justify-center rounded-full px-3.5 text-[13px] font-semibold transition-colors ${
      ...
      {view === "proyecto" ? (
        ...
        <div>
          <p className="text-sm text-[#5B6577] mb-5">
